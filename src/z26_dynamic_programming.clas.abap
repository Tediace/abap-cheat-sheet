CLASS z26_dynamic_programming DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS z26_dynamic_programming IMPLEMENTATION.
...
*    CREATE DATA dref_2 TYPE REF TO itab.
    ...
    """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    "EXAMPLE IN REAL CASE MORE DETAIL
    DATA dref_9 TYPE REF TO data.
    SELECT * FROM zdemo_abap_carr
      INTO TABLE NEW @dref_9. "must use @ for type data reference
